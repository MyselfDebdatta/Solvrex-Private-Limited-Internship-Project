//#region node_modules/.nitro/vite/services/ssr/assets/reports-CrUJoGKN.js
/**
...
var reports = [
	{
		...
		year: "2025–26",
		description: "Programme review, geography-wise coverage, measurement summary and governance disclosures for the year.",
		pages: 84,
		available: false
	},
	{
	...
	},
	{
		...
		year: "2025–26",
		description: "Balance sheet, income and expenditure, and programme-wise expense allocation with auditor notes.",
		pages: 42,
		available: false
	},
	{
	...
	},
	{
		...
		year: "2025–26",
		description: "Indicator-by-indicator results including two programmes that did not meet their targets.",
		pages: 56,
		available: false
	},
	{
	...
	},
	{
		...
		kindLabel: "Policy",
		year: "2025",
		description: "Safeguarding standards, reporting channels and response protocol for all field programmes.",
		pages: 22,
		available: false
	},
	{
		...
		kindLabel: "Policy",
		year: "2025",
		description: "How participant data is collected, stored, anonymised and consented to before publication.",
		pages: 16,
		available: false
	},
	{
		...
		kindLabel: "Policy",
		year: "2025",
		description: "Confidential reporting routes for staff, volunteers, partners and community members.",
		pages: 10,
		available: false
	},
	{
		...
		year: "2025–26",
		description: "Structure of statutory filings and audit schedule. Registration details will be published here once verified.",
		pages: 9,
		available: false
	}
];
...
//#endregion
export { reportFilters as n, reports as r, partners as t };
